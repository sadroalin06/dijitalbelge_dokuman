...
=== "cURL"
    ...
    ```    
    curl -X GET "https://app.dijitalbelge.com/api/external/signers/search" \
...
=== "JavaScript"
    ...
    ``` 
    fetch("https://app.dijitalbelge.com/api/external/signers/search", {
      headers: {
...
=== "Python"
    ...
    requests.get(
        "https://app.dijitalbelge.com/api/external/signers/search",
        headers=headers
    )
    ```
